...
##Oral
total_oral <- glm(total_cyst ~ dose_a, data = db[db$exp_route_b=="oral",], family = "poisson")
summary(total_oral)

##Proglottids
total_prog <- glm(total_cyst ~ dose_a, data = db[db$exp_route=="proglottids",], family = "poisson")
summary(total_prog)

##Eggs
total_egg <- glm(total_cyst ~ dose_a, data = db[db$exp_route=="eggs",], family = "poisson")
summary(total_egg)

##Beetles
total_bee <- glm(total_cyst ~ dose_a, data = db[db$exp_route=="beetles",], family = "poisson")
summary(total_bee)

##Carotid
total_car <- glm(total_cyst ~ dose_a, data = db[db$exp_route=="carotid",], family = "poisson")
summary(total_car)
...
##Oral
ves_oral <- glm(ves_cyst ~ dose_a, data = db[db$exp_route_b=="oral",], family = "poisson")
summary(ves_oral)

##Proglottids
ves_prog <- glm(ves_cyst ~ dose_a, data = db[db$exp_route=="proglottids",], family = "poisson")
summary(ves_prog)

##Eggs
ves_egg <- glm(ves_cyst ~ dose_a, data = db[db$exp_route=="eggs",], family = "poisson")
summary(ves_egg)

##Beetles
ves_bee <- glm(ves_cyst ~ dose_a, data = db[db$exp_route=="beetles",], family = "poisson")
summary(ves_bee)

##Carotid
ves_car <- glm(ves_cyst ~ dose_a, data = db[db$exp_route=="carotid",], family = "poisson")
summary(ves_car)
...
##Oral
brain_oral <- glm(brain_cyst ~ dose_b, data = db[db$exp_route_b=="oral",], family = "poisson")
summary(brain_oral)

##Proglottids
brain_prog <- glm(brain_cyst ~ dose_b, data = db[db$exp_route=="proglottids",], family = "poisson")
summary(brain_prog)

##Eggs
brain_egg <- glm(brain_cyst ~ dose_b, data = db[db$exp_route=="eggs",], family = "poisson")
summary(brain_egg)

##Beetles
brain_bee <- glm(brain_cyst ~ dose_b, data = db[db$exp_route=="beetles",], family = "poisson")
summary(brain_bee)

##Carotid
brain_car <- glm(brain_cyst ~ dose_b, data = db[db$exp_route=="carotid",], family = "poisson")
summary(brain_car)
